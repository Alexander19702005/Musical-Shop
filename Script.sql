...
insert into genre_artist values (7,5);
insert into genre_artist values (7,6);
insert into genre_artist values (7,7);
insert into genre_artist values (2,8);
insert into genre_artist values (5,9);
insert into genre_artist values (2,10);
insert into genre_artist values (7,11);
insert into genre_artist values (5,12);
...
insert into album_artist values (6,6);
insert into album_artist values (5,2);
