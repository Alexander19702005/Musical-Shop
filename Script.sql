...
insert into song values (1,'Старый отель','1992',2);
insert into song values (2,'Сансара','2016',1); 
insert into song values (3,'В ресторане','2013,1');
insert into song values (4,'Замыкая круг','2020',5); 
insert into song values (5,'Колыма','2002',4);
insert into song values (6,'Босоногий мальчик','2021',1); 
insert into song values (7,'Желтые ботинки','1994',2);
